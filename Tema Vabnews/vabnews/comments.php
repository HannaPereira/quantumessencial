 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ( comments_open() ) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments">Comentários trancados</p>
...
<h3><?php comment_form_title( 'Deixe seu comentário', 'Deixe seu comentário em %s' ); ?></h3>
...
<p>Logado como <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Deslogar-se &raquo;</a></p>
...
<label for="url"><small>Seu site</small></label></p>
